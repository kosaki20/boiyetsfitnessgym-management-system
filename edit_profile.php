...
<head>
    ...
    <title>Edit Profile - BOIYETS FITNESS GYM</title>
      ...
      <div class="dropdown-container">
        ...
        <div id="userDropdown" class="dropdown user-dropdown hidden">
          ...
          <div class="p-2">
            ...
            <a href="edit_profile.php" class="flex items-center gap-2 px-3 py-2 text-sm text-yellow-400 hover:bg-white/5 rounded-lg transition-colors">
  ...
  <div class="flex">
    ...
    <aside id="sidebar" class="sidebar w-60 bg-[#0d0d0d] h-screen p-3 space-y-2 flex flex-col overflow-y-auto border-r border-gray-800">
      <nav class="space-y-1 flex-1">
        ...
        <a href="edit_profile.php" class="sidebar-item active">
          <div class="flex items-center">
