<?php
/**
 * Equipment Module Deployment Script
 * Run this once to set up the module
 */

session_start();
if (!isset($_SESSION['user_id']) || $_SESSION['role'] != 'admin') {
    die("Admin access required for deployment");
}
...
echo "<h2>Equipment Module Deployment</h2>";
echo "<pre>";
...
$facility_stmt->close();
echo "✅ Facilities data inserted!\n";

// Equipment
$equipment_data = [
    ['Treadmill #1', 'Cardio Machine', 'Cardio Area', 'Good', 'Regular maintenance done last month'],
    ['Treadmill #2', 'Cardio Machine', 'Cardio Area', 'Needs Maintenance', 'Belt needs adjustment'],
    ...
    ['Leg Press Machine', 'Weight Machine', 'Weight Room', 'Under Repair', 'Hydraulic leak - parts ordered'],
    ['Dumbbell 10kg #1', 'Free Weight', 'Weight Room', 'Good', ''],
    ['Dumbbell 10kg #2', 'Free Weight', 'Weight Room', 'Good', ''],
    ['Dumbbell 20kg #1', 'Free Weight', 'Weight Room', 'Broken', 'Handle cracked - needs replacement'],
...
echo "➡️  You can now access the Equipment Monitoring module.\n";
